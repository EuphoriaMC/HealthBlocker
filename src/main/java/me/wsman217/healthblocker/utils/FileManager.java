...
public class FileManager {
    ...
    public FileManager setup(Plugin plugin) {
        ...
        for (Files file : Files.values()) {
            ...
            if (!newFile.exists()) {
                try {
                    IOUtil.saveResource((HealthBlocker) plugin, file.getFileLocation(), false);
                } catch (Exception e) {
    ...
    public static class IOUtil {
        public static void saveResource(HealthBlocker m, String resourcePath, boolean replace) {
